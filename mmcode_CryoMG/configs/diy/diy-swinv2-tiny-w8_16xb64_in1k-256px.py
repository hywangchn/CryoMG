model = dict(
    ...
    backbone=dict(
        ...
        init_cfg = dict(
            type = 'Pretrained',
            checkpoint = '../mmcls/data/swinv2-tiny-w8_3rdparty_in1k-256px_20220803-e318968f.pth',
            prefix = 'backbone'
        ),
...
data = dict(
    ...
    train=dict(
        type='ImageNet',
        classes=['0', '1'],
        data_prefix='../mmcls/data/data/train/',
    ...
    val=dict(
        type='ImageNet',
        classes=['0', '1'],
        data_prefix='../mmcls/data/data/val/',
        # ann_file='../mmcls/data/label.csv',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
...
resume_from = None
workflow = [('train', 1)]
work_dir = './work_dirs/swinv2-tiny-w8_16xb64_in1k-256px_20230919'
gpu_ids = [0]
