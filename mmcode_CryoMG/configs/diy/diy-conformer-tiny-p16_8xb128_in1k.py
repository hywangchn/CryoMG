model = dict(
    ...
    backbone=dict(
        ...
        init_cfg = dict(
            type = 'Pretrained',
            checkpoint = '../mmcls/data/conformer-tiny-p16_3rdparty_8xb128_in1k_20211206-f6860372.pth',
            prefix = 'backbone'
        ),
        type='Conformer', arch='tiny', drop_path_rate=0.1),
    neck=None,
    head=dict(
        type='ConformerHead',
        num_classes=3,
...
resume_from = None
workflow = [('train', 1)]
work_dir = './work_dirs/diy-conformer-tiny-p16_8xb128_in1k'
gpu_ids = [0]
